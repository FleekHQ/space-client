...
goog.exportSymbol('proto.space.GetPendingBucketInvitationsRequest', null, global);
goog.exportSymbol('proto.space.GetPendingBucketInvitationsResponse', null, global);
 ...
 * @constructor
 */
proto.space.GetPendingBucketInvitationsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.space.GetPendingBucketInvitationsRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.space.GetPendingBucketInvitationsRequest.displayName = 'proto.space.GetPendingBucketInvitationsRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.space.GetPendingBucketInvitationsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.space.GetPendingBucketInvitationsResponse.repeatedFields_, null);
};
goog.inherits(proto.space.GetPendingBucketInvitationsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.space.GetPendingBucketInvitationsResponse.displayName = 'proto.space.GetPendingBucketInvitationsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.space.GetPendingBucketInvitationsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.space.GetPendingBucketInvitationsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.space.GetPendingBucketInvitationsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.space.GetPendingBucketInvitationsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.space.GetPendingBucketInvitationsRequest}
 */
proto.space.GetPendingBucketInvitationsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.space.GetPendingBucketInvitationsRequest;
  return proto.space.GetPendingBucketInvitationsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.space.GetPendingBucketInvitationsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.space.GetPendingBucketInvitationsRequest}
 */
proto.space.GetPendingBucketInvitationsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.space.GetPendingBucketInvitationsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.space.GetPendingBucketInvitationsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.space.GetPendingBucketInvitationsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.space.GetPendingBucketInvitationsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.space.GetPendingBucketInvitationsResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.space.GetPendingBucketInvitationsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.space.GetPendingBucketInvitationsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.space.GetPendingBucketInvitationsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.space.GetPendingBucketInvitationsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.space.GetPendingBucketInvitationsResponse}
 */
proto.space.GetPendingBucketInvitationsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.space.GetPendingBucketInvitationsResponse;
  return proto.space.GetPendingBucketInvitationsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.space.GetPendingBucketInvitationsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.space.GetPendingBucketInvitationsResponse}
 */
proto.space.GetPendingBucketInvitationsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.space.GetPendingBucketInvitationsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.space.GetPendingBucketInvitationsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.space.GetPendingBucketInvitationsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.space.GetPendingBucketInvitationsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<!proto.space.Invitation>}
 */
proto.space.GetPendingBucketInvitationsResponse.prototype.getInvitationsList = function() {
  return /** @type{!Array<!proto.space.Invitation>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.space.Invitation, 1));
};


/**
 * @param {!Array<!proto.space.Invitation>} value
 * @return {!proto.space.GetPendingBucketInvitationsResponse} returns this
*/
proto.space.GetPendingBucketInvitationsResponse.prototype.setInvitationsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.space.Invitation=} opt_value
 * @param {number=} opt_index
 * @return {!proto.space.Invitation}
 */
proto.space.GetPendingBucketInvitationsResponse.prototype.addInvitations = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.space.Invitation, opt_index);
};
 ...
 * @return {!proto.space.GetPendingBucketInvitationsResponse} returns this
 */
proto.space.GetPendingBucketInvitationsResponse.prototype.clearInvitationsList = function() {
